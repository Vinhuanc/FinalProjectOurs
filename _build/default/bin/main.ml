...
let string_of_declaration = Project2.string_of_declaration
let mainParser = Project2.Parser.main
let mainLexer = Project2.Lexer.token
module Parser : (sig exception Error end) = Project2.Parser
